...
function render(variables = {}) {
  ...
  if (variables.socialMediaPosition === null) variables.socialMediaPosition = "right";

  if (variables.twitter === null) variables.twitter = "PaulPgpa";
  if (variables.github === null) variables.github = "PGP28";
  if (variables.linkedin === null) variables.linkedin = "Paul Guzmán";
  if (variables.instagram === null) variables.instagram = "paul.guzman_pgp";
